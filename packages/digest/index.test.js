...
for(const execArgv of process.execArgv) {
  ...
  const result = await pipeline(streams)
    ...
    equal(key, 'digest')
    equal(result.digest, 'SHA2-256:37db36876b9ccaaa88394679f019c3435af9320dea117e867003840317870e25')
    equal(value, 'SHA2-256:37db36876b9ccaaa88394679f019c3435af9320dea117e867003840317870e25')
