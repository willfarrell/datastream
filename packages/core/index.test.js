...
import {
  pipeline, pipejoin,
  streamToArray, streamToString,
  isReadable, isWritable,
  makeOptions,
  createReadableStream, createTransformStream, createWritableStream
...
test(`${variant}: makeOptions should return interoperable structure`, async (t) => {
  const options = makeOptions({objectMode:true,highWaterMark:1, chunkSize:2})
  deepEqual(options, {
    chunkSize: 2,
    highWaterMark: 1,
