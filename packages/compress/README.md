...
<p>
	...
	<br/>
	<a href="https://www.npmjs.com/package/@datastream/compress"><img alt="npm version" src="https://img.shields.io/npm/v/@datastream/compress.svg"></a>
	<a href="https://packagephobia.com/result?p=@datastream/compress"><img src="https://packagephobia.com/badge?p=@datastream/compress" alt="npm install size"></a>
	<a href="https://www.npmjs.com/package/@datastream/compress">
	<img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/@datastream/compress.svg"></a>
	<a href="https://www.npmjs.com/package/@datastream/compress#provenance">
...
```bash
npm install --save @datastream/compress
```
